    ...
    <nav className="flex justify-between w-full">
      ...
      <div className="flex justify-center items-center w-2/3">
        <ul className="list-none sm:flex hidden justify-evenly flex-1">
          ...
          <li className="mr-4 sm:flex hidden cursor-pointer text-white italic">Create Events</li>
          <li className="mr-4 md:flex hidden cursor-pointer text-white italic">Help Center</li>
          <li className="mr-4 lg:flex hidden cursor-pointer text-white italic">Find my tickets</li>
          <li className="mr-4 xl:flex hidden cursor-pointer text-white italic">Login</li>
          <li className="mr-4 2xl:flex hidden cursor-pointer text-white italic">SignUp</li>
        </ul>
